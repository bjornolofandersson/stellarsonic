...
<div class="">
  ...
  {#if expanded}
    <div class="bg-[#00000010] px-12 py-4 -ml-8 -mr-8" transition:slide={{ duration: 200, easing: quintOut }}>
      <slot/>
    </div>
  {/if}
</div>
