...
<div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
  ...
  <div class="fixed inset-0 z-10 overflow-y-auto">
    <div class="flex w-full min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      <div class="relative flex transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-[40vw] h-[70vh]">
        <div class="h-full w-[50%] bg-stone-100 p-8 flex flex-col">
          <div class="flex-grow">
            ...
            <ul class="text-stone-500 text-md text-right">
              <li class="py-2">
                Posts per page
                <input type="number" bind:value={settings.limit}>
              </li>
              <li class="py-2">Pagination</li>
            </ul>
          </div>
          <div class="py-3 sm:flex">
            <button on:click={onSave} type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">Save</button>
