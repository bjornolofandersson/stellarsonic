...
<Editor pageTitle={title} onSave={() => {}}>
  <MainPanel>
    ...
    {#if showAdd}
      <div class="mt-4 px-8 py-8 -ml-8 -mr-8 bg-[#00000010]"  transition:slide={{ duration: 200, easing: quintOut }}>
        <div class="flex mb-6">
        ...
        <div class="flex">
          <input class="w-full p-4 bg-stone-300 placeholder-stone-400 rounded-l" placeholder="Title" bind:value={postTitle}>
          <button on:click={() => {}} class="text-stone-700 disabled:text-stone-400 px-4 bg-stone-300 rounded-r border-l border-[#00000020] hover:bg-stone-200">
    ...
    <input type="search" class="w-full p-4 mt-4 bg-transparent border-b border-stone-400 focus:border-0 placeholder-stone-400" placeholder="Search posts" aria-label="Search" aria-describedby="button-addon2">
